 ...
 */
public class HGBFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_hgb, container, false);
...
//            Handle error
            if (data.size() > 4) {
                ...
                for (int i = 4; i > 0; i--) {
                    dp[4 - i] = new DataPoint(myIdList.get(data.size() - i), myHgbList.get(data.size() - i));
                ...
                gridLabel.setVerticalAxisTitle("g/dl");
                ...
                for(int i=0;i<data.size();i++){
                    dp[i] = new DataPoint(myIdList.get(i), myHgbList.get(i));
