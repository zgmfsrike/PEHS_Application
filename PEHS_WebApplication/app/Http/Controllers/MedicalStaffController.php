...
class MedicalStaffController extends Controller
{
    ...
    public function index()
    {
        ...
        $medical_staff = DB::table('users')->join('medical_staff','users.user_id','medical_staff.user_id')
        ->select('medical_staff.name','medical_staff.surname')->where('users.user_id',$user_id)->get();
