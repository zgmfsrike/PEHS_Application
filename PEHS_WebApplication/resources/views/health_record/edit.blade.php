                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="col-md-6">
                                            ...
                                            <select name="appearance" id="appearance" class="form-control{{ $errors->has('appearance') ? ' is-invalid' : '' }}" required>
                                              <option  value="" disabled selected>Please Select</option>
                                              <option  value="clear"  @if($urine_info[1]=="clear"){{'selected'}}@endif>Clear</option>
                                                <option  value="slightly cloudy"  @if($urine_info[1]=="slightly cloudy"){{'selected'}}@endif>Slightly Cloudy</option>
                                                  <option  value="cloudy"  @if($urine_info[1]=="cloudy"){{'selected'}}@endif>Cloudy</option>
                                                    <option  value="turbid"  @if($urine_info[1]=="turbid"){{'selected'}}@endif>Turbid</option>
                                                    </select>
